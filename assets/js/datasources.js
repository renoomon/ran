/* ============================================================
   ...
   الفرق عن mysources.js:
     mysources   = وين تتفرّج (سيرفرات ومواقع مشاهدة)
     datasources = من وين تجي المعلومة (تقييمات، بوسترات، توفّر)

   تضيف المصدر باسمه ومفتاحه، والموقع يناديه لكل عمل ويعرض
   اللي رجّعه تحت «بيانات إضافية» في صفحة العمل.
   ============================================================ */
...
(function (CS) {
  ...
  var PRESETS = [
    ...
    },
    {
      ...
      name: 'Fanart.tv',
      site: 'fanart.tv',
      hint: 'شعارات وخلفيات بدقة أعلى من TMDB',
    ...
    },
    {
      ...
      name: 'Trakt',
      site: 'trakt.tv',
      hint: 'إحصاءات المشاهدة والقوائم',
